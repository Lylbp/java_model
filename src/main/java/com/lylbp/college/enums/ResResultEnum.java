...
public enum ResResultEnum {
    ...
    ROLE_PERMISSION_EXIT(3005, "该角色已添加该权限,请勿重复添加"),
    USER_ROLE_EXIT(3006, "该用户已添加该角色,请勿重复添加"),
    MENU_HAS_SON_CAN_NOT_DELETE(3007, "菜单下含有子级菜单,请先删除子级菜单"),
    PARENT_MENU_NOT_EXIT(3008, "父级菜单不存在或已被删除,请刷新页面"),
    /**
     * ===========================后台用户相关===============================
     */
    ADMIN_USER_NO_EXIST(3008, "用户不存在"),
    ACTION_ADMIN_USER_IS_SUPPER(3009, "您不可以对超级管理员进行本次操作"),
    ACTION_ADMIN_PHONE_EXIT(3009, "对不起,账号已存在"),
