...
public class StringUtil {
    ...
    public static String addHost(String imgPath, HttpServletRequest request, String apiUrl) {
        String httpTag = "http";
        String refererURL = request.getHeader("https-tag");
        if (jodd.util.StringUtil.isNotEmpty(refererURL)) {
            httpTag = refererURL.toLowerCase();
        }

        String url = httpTag + "://" + request.getServerName() + ":" + request.getServerPort() + apiUrl + "?filePath=";
        return url + imgPath;
    }
