...
//    private static final String JDBC_USERNAME = "C##lylbp";
...
//    private static final String JDBC_DIVER_CLASS_NAME = "oracle.jdbc.driver.OracleDriver";
    ...
    // JDBC配置，请修改为你项目的实际配置
//    private static final String JDBC_URL = "jdbc:mysql://192.168.1.173:3306/javal_model?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&autoReconnect=true&failOverReadOnly=false&serverTimezone=Asia/Shanghai";
//    private static final String JDBC_USERNAME = "dar_college";

    private static final String JDBC_URL = "jdbc:mysql://192.168.1.173:3306/dar_college?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&autoReconnect=true&failOverReadOnly=false&serverTimezone=Asia/Shanghai";
    private static final String JDBC_USERNAME = "lylbp";
    private static final String JDBC_PASSWORD = "1qaz2wsx";
    ...
    // @author
    private static final String AUTHOR = "weiwenbin";
    // @date
    ...
    public static void main(String[] args) {
        //每次生成会覆盖原有代码 请谨慎操作！每次生成会覆盖原有代码 请谨慎操作！每次生成会覆盖原有代码 请谨慎操作！每次生成会覆盖原有代码 请谨慎操作！
//        genCode("cfg_content_type","cfg_course_level_1","cfg_course_level_2",
//                "t_dar_admin_user","t_dar_clue_info","t_dar_clue_object","t_dar_content","t_dar_course",
//                "t_dar_course_introduction","t_dar_course_learn","t_dar_dynamics_info",
//                "t_dar_dynamics_object","t_dar_enclosure","t_dar_image","t_dar_lesson","t_dar_news_info",
//                "t_dar_news_object","t_dar_notice_info","t_dar_notice_object","t_dar_organization",
//                "t_dar_organization_user_relation","t_dar_regulations_info","t_dar_regulations_object",
//                "t_dar_release_info","t_dar_update_version","t_dar_user_course","t_dar_user_info","t_dar_work_flow"
//                ,"t_dar_work_info","t_dar_work_object");

//        genCode("t_dar_verification_code");
